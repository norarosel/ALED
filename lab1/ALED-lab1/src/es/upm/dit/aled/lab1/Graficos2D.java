...
public final class Graficos2D {
    ...
    private CompositionGraficos2D container;
    private JLabel draw;
    ...
    public Graficos2D(int width, int height) {
    	setCanvasSize(width,height);
	}

    public void setContainer(CompositionGraficos2D container) {
		this.container=container;
    }
    
    public CompositionGraficos2D getContainer() {
    	return container;
    }
     ...
     * Throws a java.lang.IllegalArgumentException if the width or height is 0 or negative
     *
    ...
    *************************************************************************/
    ...
    private Image getImage(String filename) {
        ...
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = Graficos2D.class.getResource(filename);
